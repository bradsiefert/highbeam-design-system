<template>
  <div>
    ...
    <router-link class="nav-link" to="/designsystem/data/graphs">Filters <span class="badge rounded-pill bg-highlight text-dark">Coming Soon</span></router-link>
    ...
    <router-link class="nav-link" to="/designsystem/ui/popovers/">Popovers <span class="badge rounded-pill bg-highlight text-dark">Coming Soon</span></router-link>
    <router-link class="nav-link" to="/designsystem/ui/tooltips/">Tooltips <span class="badge rounded-pill bg-highlight text-dark">Coming Soon</span></router-link>
  </div>
</template>
